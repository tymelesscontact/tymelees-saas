...
const LANGS = [
  ...
  { code: "ja", flag: "🇯🇵", label: "日本語", dir: "ltr" },
];
...
const T = {
  fr: {
    ...
    multiTitle: "Multi-Sociétés",
    multiH2a: "Vous gérez plusieurs",
    multiH2b: "sociétés ?",
    multiNames: ["Duo", "Groupe", "Holding"],
    multiDesc: [
      "Pour les groupes de 2 à 5 sociétés. Un tableau de bord, toutes vos structures.",
      "Pour les groupes de 6 sociétés et plus. Consolidation et pilotage centralisé.",
  ...
  en: {
    ...
    multiTitle: "Multi-Company",
    multiH2a: "Managing several",
    multiH2b: "companies?",
    multiNames: ["Duo", "Group", "Holding"],
    multiDesc: [
      "For groups of 2 to 5 companies. One dashboard, all your entities.",
      "For groups of 6+ companies. Centralized consolidation and control.",
  ...
  ar: {
    ...
    multiTitle: "متعدد الشركات",
    multiH2a: "هل تدير عدة",
    multiH2b: "شركات؟",
    multiNames: ["ثنائي", "مجموعة", "قابضة"],
    multiDesc: [
      "لمجموعات من 2 إلى 5 شركات. لوحة تحكم واحدة، لجميع كياناتك.",
      "لمجموعات من 6 شركات فأكثر. توحيد وإدارة مركزية.",
  ...
  pt: {
    ...
    multiTitle: "Multi-Empresas",
    multiH2a: "Gerencia várias",
    multiH2b: "empresas?",
    multiNames: ["Duo", "Grupo", "Holding"],
    multiDesc: [
      "Para grupos de 2 a 5 empresas. Um painel, todas as suas entidades.",
      "Para grupos de 6+ empresas. Consolidação e controle centralizados.",
  ...
  zh: {
    ...
    h1b: "管理系统，",
    h1c: "遍布全球",
    sub: "钱包、报价、客户关系管理、排期、AI获客、虚拟卡 — 一个仪表盘搞定一切。",
    payLabel: "支付方式：",
    trialBox1: "🎁 免费试用14天",
    trialBox2: "完整访问 · 无需信用卡 · 随时取消",
    cta1: "🚀 免费开始 — 14天",
    cta2: "▶ 观看演示",
    statsLabels: ["活跃企业", "客户满意度", "覆盖国家", "起价 / 月"],
    featTitle: "功能",
    featH2a: "12个模块。一个",
    featH2b: "集成生态系统。",
    sectTitle: "适合谁",
    sectH2a: "无论您从事什么行业，",
    sectH2b: "Xyra都能适应。",
    sectSub: "注册时选择您的行业 — 仪表盘会自动适应您的需求。",
    pricingTitle: "价格",
    pricingH2a: "从您需要的",
    pricingH2b: "开始。",
    monthly: "月付",
    ...
    annualSave: "−20% · 免费2个月",
    billedAnnual: "· 按年计费",
    trialBadge: "🎁 免费试用14天 · 无需信用卡",
    guarantees: ["🆓 14天免费试用", "✅ 30天满意保证", "🔄 随时更改套餐", "💳 无需承诺"],
    faqTitle: "常见问题",
    faqH2a: "常见",
    faqH2b: "问题。",
    ctaTitle: "准备好开始了吗？",
    ctaH2a: "加入47家以上",
    ctaH2b: "使用Xyra管理一切的企业。",
    ctaSub: "免费14天 · 无需信用卡 · 立即访问",
    ctaBtn1: "🚀 免费开始 — 14天",
    ctaBtn2: "💬 申请演示",
    ...
    footerCopy: "© 2026 Xyra — 版权所有",
    footerPay: "支付方式：",
    waTooltip: "我们5分钟内回复！",
    waMsg: "您好%2C%20我想了解更多关于Xyra的信息",
    waDemo: "您好%2C%20我想预约Xyra演示",
    recommended: "推荐",
    planDesc: ["以基本工具开启您的业务。", "适合成长型企业的完整方案。", "适合大型机构和多地点连锁店。"],
    planCta: ["免费开始", "开始试用", "联系我们"],
    planFeatures: [
      ["可选3个模块", "含Wallet与Flutterwave", "1个用户", "WhatsApp支持"],
      ["可选8个模块", "钱包+虚拟卡", "最多5个用户", "含AI与分析", "优先支持"],
      ["所有模块", "无限VIP卡", "无限用户", "完整AI获客", "7天专属支持", "定制配置"],
    ],
    planNo: [["AI与分析", "自动获客"], ["自动获客"], []],
    multiTitle: "多公司",
    multiH2a: "管理多家",
    multiH2b: "公司？",
    multiNames: ["双公司", "集团", "控股"],
    multiDesc: [
      "适合2至5家公司的集团。一个仪表盘，管理所有实体。",
      "适合6家以上公司的集团。集中整合与管控。",
    ...
    modules: [
      ...
      { icon: "💳", label: "钱包与支付", desc: "Wave、Orange Money、Visa、SEPA" },
      { icon: "👥", label: "客户CRM", desc: "VIP、多语言、历史记录" },
      { icon: "🤝", label: "合作伙伴", desc: "佣金、推荐业绩" },
      { icon: "📅", label: "排期", desc: "按员工分配的每周任务" },
      { icon: "🔍", label: "AI获客", desc: "多渠道，59项功能" },
      { icon: "📈", label: "分析", desc: "营收预测、趋势、增长" },
      { icon: "💎", label: "虚拟卡", desc: "为您的团队提供Visa虚拟卡" },
      { icon: "⭐", label: "NPS与评价", desc: "谷歌评价、客户满意度" },
      { icon: "💬", label: "团队聊天", desc: "类WhatsApp、实时" },
      { icon: "🚀", label: "SaaS部署", desc: "白标，您的客户" },
    ],
    testimonials: [
      { name: "Aminata D.", role: "礼宾服务 — 达喀尔，塞内加尔", text: "以前我用Excel和WhatsApp管理一切。现在报价30秒内发送，客户用Wave付款，一切都有记录。每天节省2小时。" },
      { name: "Marc T.", role: "园艺师 — 里昂，法国", text: "我以为这些工具不适合我。Xyra让我惊讶——10分钟内我的排期、报价和钱包都配置好了。" },
      { name: "Sofia R.", role: "活动策划公司 — 巴黎与卡萨布兰卡", text: "我们同时接受Orange Money和Visa。获客机器人一个月内为我们带来8个新客户。" },
    ],
    faqs: [
      { q: "Xyra适合我的行业吗？", a: "适合！Xyra是通用的——园丁、水管工、礼宾服务、餐厅、律师、建筑、教练...注册时选择您的行业，仪表盘会自动适应。" },
      { q: "接受哪些支付方式？", a: "通过Flutterwave：Wave、Orange Money、MTN Mobile Money、Airtel Money、Visa、Mastercard、SEPA转账、PayPal。覆盖非洲、欧洲和全球。" },
      { q: "我的数据安全吗？", a: "绝对安全。每家企业的数据100%隔离。安全的Supabase基础设施，符合GDPR，端到端加密。" },
      { q: "可以只租用一个模块吗？", a: "可以！您可以只租用您需要的模块——例如仅钱包与支付，29欧元/月。随时添加其他模块。" },
      { q: "有客户支持吗？", a: "WhatsApp支持每周7天可用。完整的法语文档。视频教程。企业方案包含专属支持与个性化陪同。" },
      { q: "Xyra在非洲可用吗？", a: "这是我们的一大优势！专为法国和非洲设计——塞内加尔、科特迪瓦、摩洛哥、喀麦隆、迪拜。Wave和Orange Money原生集成。" },
      { q: "可以随时取消吗？", a: "可以，无费用，无承诺。您可以随时从仪表盘取消、更改方案或添加模块。" },
    ],
  },
  ja: {
    trial: "🎁 14日間無料トライアル — フルアクセス · クレジットカード不要 · 契約不要",
    nav: ["機能", "業界", "料金", "よくある質問"],
    navCta: "14日間無料トライアル →",
    badge: "フランス · アフリカ · 世界中で利用可能",
    h1a: "あらゆるビジネスのための",
    h1b: "管理システム、",
    h1c: "世界中どこでも",
    sub: "ウォレット、見積、CRM、スケジュール、AI営業、バーチャルカード — すべて一つのダッシュボードに。",
    payLabel: "支払い方法：",
    trialBox1: "🎁 14日間無料",
    trialBox2: "フルアクセス · クレジットカード不要 · いつでも解約可能",
    cta1: "🚀 無料で始める — 14日間",
    cta2: "▶ デモを見る",
    statsLabels: ["稼働中の企業", "顧客満足度", "対応国数", "月額から"],
    featTitle: "機能",
    featH2a: "12のモジュール。ひとつの",
    featH2b: "統合エコシステム。",
    sectTitle: "対象業種",
    sectH2a: "業種を問わず、",
    sectH2b: "Xyraが対応します。",
    sectSub: "登録時に業種を選択 — ダッシュボードが自動的に最適化されます。",
    pricingTitle: "料金",
    pricingH2a: "必要なものから",
    pricingH2b: "始めましょう。",
    monthly: "月払い",
    ...
    annualSave: "−20% · 2ヶ月無料",
    billedAnnual: "· 年間請求",
    trialBadge: "🎁 14日間無料 · カード不要",
    guarantees: ["🆓 14日間無料トライアル", "✅ 30日間満足保証", "🔄 いつでもプラン変更", "💳 契約不要"],
    faqTitle: "よくある質問",
    faqH2a: "よくある",
    faqH2b: "ご質問。",
    ctaTitle: "始める準備はできましたか？",
    ctaH2a: "47社以上の企業が",
    ctaH2b: "Xyraですべてを管理しています。",
    ctaSub: "14日間無料 · クレジットカード不要 · 即時アクセス",
    ctaBtn1: "🚀 無料で始める — 14日間",
    ctaBtn2: "💬 デモを依頼する",
    ...
    footerCopy: "© 2026 Xyra — 全著作権所有",
    footerPay: "お支払い方法：",
    waTooltip: "5分以内に返信します！",
    waMsg: "こんにちは%2C%20Xyraについて詳しく知りたいです",
    waDemo: "こんにちは%2C%20Xyraのデモを希望します",
    recommended: "おすすめ",
    planDesc: ["必須ツールでビジネスを始める。", "成長企業向けの完全プラン。", "大規模組織・複数拠点フランチャイズ向け。"],
    planCta: ["無料で始める", "トライアルを開始", "お問い合わせ"],
    planFeatures: [
      ["3モジュール選択可", "Wallet & Flutterwave含む", "1ユーザー", "WhatsAppサポート"],
      ["8モジュール選択可", "ウォレット+バーチャルカード", "最大5ユーザー", "AI＆分析付き", "優先サポート"],
      ["全モジュール", "無制限VIPカード", "無制限ユーザー", "完全AI営業", "専属7日間サポート", "カスタム設定"],
    ],
    planNo: [["AI＆分析", "自動営業"], ["自動営業"], []],
    multiTitle: "複数会社",
    multiH2a: "複数の会社を",
    multiH2b: "運営していますか？",
    multiNames: ["デュオ", "グループ", "ホールディング"],
    multiDesc: [
      "2〜5社のグループ向け。ひとつのダッシュボードで全法人を管理。",
      "6社以上のグループ向け。集中管理と統合。",
    ...
    modules: [
      ...
      { icon: "💳", label: "ウォレット＆決済", desc: "Wave、Orange Money、Visa、SEPA" },
      { icon: "👥", label: "顧客CRM", desc: "VIP、多言語、履歴管理" },
      { icon: "🤝", label: "パートナー", desc: "手数料、紹介実績" },
      { icon: "📅", label: "スケジュール", desc: "担当者別の週間業務" },
      { icon: "🔍", label: "AI営業", desc: "マルチチャネル、59機能" },
      { icon: "📈", label: "分析", desc: "売上予測、トレンド、成長" },
      { icon: "💎", label: "バーチャルカード", desc: "チーム用Visaバーチャルカード" },
      { icon: "⭐", label: "NPS＆評価", desc: "Googleレビュー、顧客満足度" },
      { icon: "💬", label: "チームチャット", desc: "WhatsApp風、リアルタイム" },
      { icon: "🚀", label: "SaaS展開", desc: "ホワイトラベル、あなたの顧客向け" },
    ],
    testimonials: [
      { name: "Aminata D.", role: "コンシェルジュサービス — ダカール、セネガル", text: "以前はExcelとWhatsAppですべて管理していました。今は見積りが30秒で送信され、顧客はWaveで支払い、すべて記録されます。毎日2時間節約できています。" },
      { name: "Marc T.", role: "造園業 — リヨン、フランス", text: "こうしたツールは自分には向いていないと思っていました。Xyraには驚きました——10分でスケジュール、見積、ウォレットが設定できました。" },
      { name: "Sofia R.", role: "イベント企画会社 — パリ＆カサブランカ", text: "Orange MoneyとVisaを同時に受け付けています。営業ボットが1ヶ月で8件の新規顧客をもたらしました。" },
    ],
    faqs: [
      { q: "Xyraは私の業界に合っていますか？", a: "はい！Xyraは万能です——庭師、配管工、コンシェルジュ、レストラン、弁護士、建設、コーチなど。登録時に業界を選択すると、ダッシュボードが自動的に最適化されます。" },
      { q: "どのような支払い方法が利用できますか？", a: "Flutterwave経由：Wave、Orange Money、MTN Mobile Money、Airtel Money、Visa、Mastercard、SEPA送金、PayPal。アフリカ、ヨーロッパ、世界中に対応。" },
      { q: "データは安全ですか？", a: "もちろんです。各企業のデータは100%分離されています。安全なSupabaseインフラ、GDPR準拠、エンドツーエンド暗号化。" },
      { q: "モジュールを1つだけレンタルできますか？", a: "はい！必要なモジュールだけをレンタルできます——例えばウォレット＆決済だけなら月29ユーロから。いつでも他のモジュールを追加できます。" },
      { q: "サポートはありますか？", a: "WhatsAppサポートは週7日利用可能。完全なフランス語ドキュメント。動画チュートリアル。エンタープライズプランには専属サポートが含まれます。" },
      { q: "Xyraはアフリカで利用できますか？", a: "それが私たちの強みの一つです！フランスとアフリカ向けに設計されています——セネガル、コートジボワール、モロッコ、カメルーン、ドバイ。WaveとOrange Moneyがネイティブ統合されています。" },
      { q: "いつでも解約できますか？", a: "はい、手数料なし、契約なしで。いつでもダッシュボードから解約、プラン変更、モジュール追加ができます。" },
    ],
  },
};
